  ...
  return (
    <nav className='navbar'>
        ...
        <div className='discktopMenu'>
            ...
            <Link activeClass='active' to='works' spy ={true} smooth = {true} offset={-80} duration={500} className='descktopMenuListitem'>Portfolio</Link>
            <Link activeClass='active' to='client' spy ={true} smooth = {true} offset={-80} duration={500} className='descktopMenuListitem'>Internship</Link>
        </div>
        ...
        <div className='navMenu' style={{display: showMenu ? 'flex' : 'none'}}>
            ...
            <Link activeClass='active' to='client' spy ={true} smooth = {true} offset={-100} duration={500} className='listitem' onClick={() => setShowMenu(false)}>Internship</Link>
